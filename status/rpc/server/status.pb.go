...
var file_status_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x4e, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	...
	0x73, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x7a, 0x0a,
	0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	0x43, 0x6f, 0x6e, 0x6e, 0x12, 0x14, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x74,
	...
	0x65, 0x12, 0x36, 0x0a, 0x07, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x73, 0x67, 0x12, 0x14, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x3b,
...
var file_status_proto_goTypes = []interface{}{
	(*StateRequest)(nil),  // 0: server.StateRequest
	(*StateResponse)(nil), // 1: server.StateResponse
}
var file_status_proto_depIdxs = []int32{
	0, // 0: server.state.CancelConn:input_type -> server.StateRequest
	0, // 1: server.state.SendMsg:input_type -> server.StateRequest
	1, // 2: server.state.CancelConn:output_type -> server.StateResponse
	1, // 3: server.state.SendMsg:output_type -> server.StateResponse
...
func (c *stateClient) CancelConn(ctx context.Context, in *StateRequest, opts ...grpc.CallOption) (*StateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/server.state/CancelConn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stateClient) SendMsg(ctx context.Context, in *StateRequest, opts ...grpc.CallOption) (*StateResponse, error) {
	out := new(StateResponse)
	err := c.cc.Invoke(ctx, "/server.state/SendMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _State_CancelConn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.state/CancelConn",
	}
...
func _State_SendMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.state/SendMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
