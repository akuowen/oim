...
var file_gateway_proto_rawDesc = []byte{
	...
	0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x34, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x66, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x66, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74,
	...
	,
...
var file_gateway_proto_goTypes = []interface{}{
	(*GatewayRequest)(nil),  // 0: server.GatewayRequest
	(*GatewayResponse)(nil), // 1: server.GatewayResponse
}
var file_gateway_proto_depIdxs = []int32{
	0, // 0: server.Gateway.DelConn:input_type -> server.GatewayRequest
	0, // 1: server.Gateway.Push:input_type -> server.GatewayRequest
	1, // 2: server.Gateway.DelConn:output_type -> server.GatewayResponse
	1, // 3: server.Gateway.Push:output_type -> server.GatewayResponse
...
func (c *gatewayClient) DelConn(ctx context.Context, in *GatewayRequest, opts ...grpc.CallOption) (*GatewayResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/server.Gateway/DelConn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) Push(ctx context.Context, in *GatewayRequest, opts ...grpc.CallOption) (*GatewayResponse, error) {
	out := new(GatewayResponse)
	err := c.cc.Invoke(ctx, "/server.Gateway/Push", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_DelConn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.Gateway/DelConn",
	}
...
func _Gateway_Push_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.Gateway/Push",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
